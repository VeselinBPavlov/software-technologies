...
class User implements UserInterface
{
     ...
     * @var string
     *
     * @ORM\Column(name="scienceDegree", type="string", length=255)
     */
    ...
    /**
     * Get the value of scienceDegree
     *
     * @return  string
     */ 
    ...
    /**
     * Set the value of scienceDegree
     *
     * @param  string  $scienceDegree
     *
     * @return  User
     */ 
    public function setScienceDegree(string $scienceDegree)
    {
